...
#sudo scutil --set ComputerName "Fuu"
#sudo scutil --set HostName "Fuu"
#sudo scutil --set LocalHostName "Fuu"
#sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Fuu"
...
open "$HOME/init/birdsigh.terminal"
sleep 1
defaults write com.apple.terminal "Default Window Settings" -string "Birdsigh"
defaults write com.apple.terminal "Startup Window Settings" -string "Birdsigh"
